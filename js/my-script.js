...
// Header shearch sliding, checklist
$(document).on('ready', function() {
	$('body').click(function(e){
		$(".searchHolder").removeClass("select_search")
	});
	$('.searchHolder').click(function(e){
		 $('.searchHolder').addClass('select_search');
...
$(document).ready(function(){
  ...
  $(".field_holder input").keypress(function(){
     $(this).parent(".field_holder").removeClass("fill_requid");
  });
  ...
  $("form").submit(function(e){
    event.preventDefault();
			...
			if( $(".name input").val().length == 0 ){
				$(".name").addClass("fill_requid");
			} else {
				$(".name").removeClass("fill_requid");
			}
      if( $(".email input").val().length == 0 ){
        $(".email").addClass("fill_requid");
      } else {
        $(".email").removeClass("fill_requid");
      }

			if ( $(".password input").val().length == 0 ){
        $(".password").addClass("fill_requid");
      } else {
        $(".password").removeClass("fill_requid");
      }
			if( $(".checklist-inner input").is(":checked") ){
        $(".checklist-inner").removeClass("fill_requid")
      } else {
        $(".checklist-inner").addClass("fill_requid");
      }
      return false;
